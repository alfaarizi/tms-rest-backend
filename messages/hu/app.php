...
return [
    ...
    'Cannot remove last lecturer!' => 'Az utolsó oktatót nem lehet eltávolítani!',
    'Category' => 'Kategória',
    'Canvas id' => 'Canvas id',
    'Canvas token' => 'Canvas token',
    'Canvas Course' => 'Canvas kurzus',
    'Canvas Section' => 'Canvas kurzusszekció',
    'Canvas synchronization level' => 'Canvas szinkronizációs szint',
    'Sync level must be an array' => 'A szinkronizációs szintnek tömbnek kell lennie',
    'Invalid sync level values: {values}' => 'Érvénytelen szinkronizációs szint értékek: {values}',
    'Name lists must be synchronized' => 'A névlistáknak szinkronizálva kell lenniük',
    ...
    'Invalid name parameter!' => 'Érvénytelen név paraméter!',
    'Task files' => 'Oktatói állományok',
    'Invalid timezone' => 'Érvénytelen időzóna',
    'Both Day and Start Time must be set together or both left empty.' => 'A nap és a kezdési idő vagy együtt adandó meg, vagy egyik sem.',
    'The day must be between Monday (1) and Sunday (7).' => 'A napnak Hétfő (1) és Vasárnap (7) között kell lennie.',
    ...
    'no' => 'nem',
    'yes' => 'igen',
    'Validation Password' => 'Hitelesítő Jelszó',
    'Task Password' => 'Beadandó Jelszó',
    'This task is password protected, unlock it with the password first!' => 'Ez a feladat jelszóval védett, először oldja fel!',
    ...
    "Task File not found." => "Az oktatói állomány nem található.",
    "Task File not available." => "Az oktatói állomány nem elérhető.",
    ...
    'The current values of autoTesterStatus and status are not valid' => 'Az autoTesterStatus és status mezők jelenlegi értékei érvénytelenek',
    ...
    'Failed create course. Message: ' => 'A kurzus létrehozása sikertelen volt. Üzenet: ',
    'Failed to save structural requirement. Message:' => 'A strukturális követelmény létrehozása sikertelen volt. Üzenet: ',
    'Failed create instructor course. Message: ' => 'Az instructor course létrehozása sikertelen volt. Üzenet: ',
