...
class InstructorQuizQuestionSetCest
{
    ...
    {
        $I->sendGet("/instructor/quiz-question-sets");
    ...
    {
        $I->sendGet("/instructor/quiz-question-sets/0");
        $I->seeResponseCodeIs(HttpCode::NOT_FOUND);
    }

    public function viewPermissionDenied(ApiTester $I)
    {
        $I->sendGet("/instructor/quiz-question-sets/4");
        $I->seeResponseCodeIs(HttpCode::FORBIDDEN);
    }

    public function view(ApiTester $I)
    {
        $I->sendGet("/instructor/quiz-question-sets/1");
        $I->seeResponseCodeIs(HttpCode::OK);
    ...
    {
        $I->sendPatch(
            "/instructor/quiz-question-sets/1",
            [
                'name' => 'Updated Test',
                'courseID' => 4000,
            ]
    ...
    {
        $I->sendPatch(
            "/instructor/quiz-question-sets/0",
            [
                'name' => 'Updated Test',
                'courseID' => 1,
            ]
    ...
    {
        $I->sendPatch(
            "/instructor/quiz-question-sets/4",
            [
                'name' => 'Updated Test',
                'courseID' => 4002,
            ]
    ...
    {
        $I->sendPatch(
            "/instructor/quiz-question-sets/3",
            [
                'name' => 'Updated Test',
                'courseID' => 4000,
            ]
    ...
    {
        $I->sendDelete("/instructor/quiz-question-sets/0");
        $I->seeResponseCodeIs(HttpCode::NOT_FOUND);
    }

    public function deleteWithoutPermission(ApiTester $I)
    {
        $I->sendDelete("/instructor/quiz-question-sets/4");
        $I->seeResponseCodeIs(HttpCode::FORBIDDEN);
        $I->seeRecord(QuizQuestionSet::class, ['id' => 4]);
    }

    public function deleteFinalized(ApiTester $I)
    {
        $I->sendDelete("/instructor/quiz-question-sets/1");
        $I->seeResponseCodeIs(HttpCode::CONFLICT);
        $I->seeRecord(QuizQuestionSet::class, ['id' => 1]);
    }

    public function deleteValid(ApiTester $I)
    {
        $I->sendDelete("/instructor/quiz-question-sets/3");
        $I->seeResponseCodeIs(HttpCode::NO_CONTENT);
        $I->cantSeeRecord(QuizQuestionSet::class, ['id' => 3]);
    }

    public function listImagesNotFound(ApiTester $I)
    {
        $I->sendGet("/instructor/quiz-question-sets/0/images");
        $I->seeResponseCodeIs(HttpCode::NOT_FOUND);
    }

    public function listImagesWithoutPermission(ApiTester $I)
    {
        $I->sendGet("/instructor/quiz-question-sets/4/images");
        $I->seeResponseCodeIs(HttpCode::FORBIDDEN);
    }

    public function listImages(ApiTester $I)
    {
        $I->sendGet("/instructor/quiz-question-sets/1/images");
        $I->seeResponseCodeIs(HttpCode::OK);
    ...
    {
        $I->sendDelete("/instructor/quiz-question-sets/0/images/img1.jpg");
        $I->seeResponseCodeIs(HttpCode::NOT_FOUND);
    }

    public function deleteImageImageNotFound(ApiTester $I)
    {
        $I->sendDelete("/instructor/quiz-question-sets/1/images/img0.jpg");
        $I->seeResponseCodeIs(HttpCode::NOT_FOUND);
    }

    public function deleteImageWithoutPermission(ApiTester $I)
    {
        $I->sendDelete("/instructor/quiz-question-sets/4/images/img1.jpg");
        $I->seeResponseCodeIs(HttpCode::FORBIDDEN);
    }

    public function deleteImage(ApiTester $I)
    {
        $I->sendDelete("/instructor/quiz-question-sets/1/images/img1.jpg");
        $I->seeResponseCodeIs(HttpCode::NO_CONTENT);
    ...
    {
        $I->sendPost(
            "/instructor/quiz-question-sets/0/images",
            [],
    ...
    {
        $I->sendPost(
            "/instructor/quiz-question-sets/4/images",
            [],
            ['path' => codecept_data_dir("upload_samples/upload_img1.jpg")]
        );
        $I->seeResponseCodeIs(HttpCode::FORBIDDEN);
    ...
    {
        $I->sendPost(
            '/instructor/quiz-question-sets/1/images',
            [],
            [
                'path' => [
