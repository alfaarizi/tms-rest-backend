...
class InstructorQuizTestsCest
{
    ...
    {
        $I->sendGet('/instructor/quiz-tests/index?semesterID=3001');
    ...
    {
        $I->sendGet('/instructor/quiz-tests/0');
        $I->seeResponseCodeIs(HttpCode::NOT_FOUND);
    }

    public function viewWithoutPermission(ApiTester $I)
    {
        $I->sendGet('/instructor/quiz-tests/9');
        $I->seeResponseCodeIs(HttpCode::FORBIDDEN);
    }

    public function view(ApiTester $I)
    {
        $I->sendGet('/instructor/quiz-tests/10');
        $I->seeResponseCodeIs(HttpCode::OK);
        $I->seeResponseMatchesJsonType(self::TEST_SCHEMA);
        $I->seeResponseContainsJson(
            [
    ...
    public function createInvalid(ApiTester $I)
    {
        ...
        $I->cantSeeRecord(QuizTest::class, ['name' => 'Created']);
    }
    ...
    public function updateInvalid(ApiTester $I)
    {
        ...
        $I->seeResponseCodeIs(HttpCode::UNPROCESSABLE_ENTITY);
        $I->seeResponseMatchesJsonType(['string'], '$.[*]');
        $I->cantSeeRecord(QuizTest::class, ['name' => '']);
    }

    public function updateWithoutPermission(ApiTester $I)
    {
        $I->sendPatch(
            '/instructor/quiz-tests/9',
            [
                'name' => 'Updated',
                'questionamount' => 1,
            ]
        ...
        $I->seeResponseCodeIs(HttpCode::FORBIDDEN);
        $I->cantSeeRecord(QuizTest::class, ['name' => 'Updated']);
    }

    public function updateFinalized(ApiTester $I)
    {
        $I->sendPatch(
            '/instructor/quiz-tests/1',
            [
                'name' => 'Updated'
            ]
        );
    ...
    {
        $I->sendDelete('/instructor/quiz-tests/9');
        $I->seeResponseCodeIs(HttpCode::FORBIDDEN);
        $I->seeRecord(QuizTest::class, ['id' => 9]);
    }

    public function deleteFinalized(ApiTester $I)
    {
        $I->sendDelete('/instructor/quiz-tests/1');
        $I->seeResponseCodeIs(HttpCode::CONFLICT);
        $I->seeRecord(QuizTest::class, ['id' => 1]);
    }

    public function deleteNotFound(ApiTester $I)
    {
        $I->sendDelete('/instructor/quiz-tests/0');
        $I->seeResponseCodeIs(HttpCode::NOT_FOUND);
    }

    public function delete(ApiTester $I)
    {
        $I->sendDelete('/instructor/quiz-tests/11');
        $I->seeResponseCodeIs(HttpCode::NO_CONTENT);
        $I->cantSeeRecord(QuizTest::class, ['id' => 11]);
    }

    public function duplicateNotFound(ApiTester $I)
    {
        $I->sendPost("/instructor/quiz-tests/0/duplicate");
        $I->seeResponseCodeIs(HttpCode::NOT_FOUND);
    }

    public function duplicateWithoutPermission(ApiTester $I)
    {
        $I->sendPost("/instructor/quiz-tests/9/duplicate");
        $I->seeResponseCodeIs(HttpCode::FORBIDDEN);
    }

    public function duplicateAvailable(ApiTester $I)
    {
        $I->sendPost("/instructor/quiz-tests/1/duplicate");
        $I->seeResponseCodeIs(HttpCode::CREATED);
        $I->seeResponseMatchesJsonType(self::TEST_SCHEMA);

        $test = $I->grabRecord(QuizTest::class, ['id' => 1]);
    ...
    {
        $I->sendPost("/instructor/quiz-tests/0/finalize");
        $I->seeResponseCodeIs(HttpCode::NOT_FOUND);
    }

    public function finalizeWithoutPermission(ApiTester $I)
    {
        $I->sendPost("/instructor/quiz-tests/9/finalize");
        $I->seeResponseCodeIs(HttpCode::FORBIDDEN);
    }

    public function finalizeWithoutEnoughQuestions(ApiTester $I)
    {
        $I->sendPost("/instructor/quiz-tests/11/finalize");
    ...
    {
        $I->sendPost("/instructor/quiz-tests/12/finalize");
        $I->seeResponseCodeIs(HttpCode::BAD_REQUEST);
        $I->seeResponseContainsJson(
            [
    ...
    {
        $I->sendPost("/instructor/quiz-tests/10/finalize");
        $I->seeResponseCodeIs(HttpCode::NO_CONTENT);
