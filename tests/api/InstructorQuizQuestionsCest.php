...
class InstructorQuizQuestionsCest
{
    ...
    {
        $I->sendGet("/instructor/quiz-questions/list-for-set?questionsetID=1");
    ...
    {
        $I->sendGet("/instructor/quiz-questions/list-for-set?questionsetID=0");
        $I->seeResponseCodeIs(HttpCode::NOT_FOUND);
    }

    public function listForSetWithoutPermission(ApiTester $I)
    {
        $I->sendGet("/instructor/quiz-questions/list-for-set?questionsetID=4");
        $I->seeResponseCodeIs(HttpCode::FORBIDDEN);
    }

    public function listForTestNotFound(ApiTester $I)
    {
        $I->sendGet("/instructor/quiz-questions/list-for-test?testID=0");
        $I->seeResponseCodeIs(HttpCode::NOT_FOUND);
    }

    public function listForTestWithoutPermission(ApiTester $I)
    {
        $I->sendGet("/instructor/quiz-questions/list-for-test?testID=9");
        $I->seeResponseCodeIs(HttpCode::FORBIDDEN);
    }

    public function listForTestNotUnique(ApiTester $I)
    {
        $I->sendGet("/instructor/quiz-questions/list-for-test?testID=8");
        $I->seeResponseCodeIs(HttpCode::OK);
        $I->seeResponseContainsJson(
            [
                'id' => 1,
    ...
    {
        $I->sendGet("/instructor/quiz-questions/list-for-test?testID=1");
        $I->seeResponseCodeIs(HttpCode::BAD_REQUEST);
    }

    public function listForTestUnique(ApiTester $I)
    {
        $I->sendGet("/instructor/quiz-questions/list-for-test?testID=8&userID=3");
        $I->seeResponseCodeIs(HttpCode::OK);
    ...
    {
        $I->sendDelete('/instructor/quiz-questions/0');
        $I->seeResponseCodeIs(HttpCode::NOT_FOUND);
    }

    public function deleteWithoutPermission(ApiTester $I)
    {
        $I->sendDelete('/instructor/quiz-questions/5');
        $I->seeResponseCodeIs(HttpCode::FORBIDDEN);
        $I->seeRecord(
            QuizQuestion::class,
            [
    ...
    {
        $I->sendDelete('/instructor/quiz-questions/1');
        $I->seeResponseCodeIs(HttpCode::CONFLICT);
        $I->seeRecord(
            QuizQuestion::class,
            [
    ...
    {
        $I->sendDelete('/instructor/quiz-questions/6');
