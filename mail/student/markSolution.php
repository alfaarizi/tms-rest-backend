...
MailHtml::table([
    ...
    ['th' => Yii::t('app/mail', 'Status'), 'td' => Yii::t('app', $submission->status)],
    ['th' => Yii::t('app/mail', 'Grade'), 'td' => $submission->grade],
    ['th' => Yii::t('app/mail', 'Remark'), 'td' => Html::encode(nl2br($submission->notes, false))],
    ['th' => Yii::t('app/mail', 'Modifier'), 'td' => (!$group->isExamGroup) ? Html::encode($actor->name) : '']
])
?>
