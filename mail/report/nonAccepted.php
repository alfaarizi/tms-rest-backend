...
<?php foreach ($results as $result) : ?>
    ...
    MailHtml::table([
        [
            'th' => "Név",
            'td' => Html::encode("{$result['userName']} ({$result['userCode']})")
        ],
        [
            'th' => "Kurzus",
            'td' => Html::encode("{$result['courseName']} ({$result['courseCode']}/{$result['groupNumber']})")
        ],
        [
            'th' => "Feladat",
            'td' => $result['taskName']
        ...
        [
            'th' => "Állapot",
            'td' =>  Yii::t('app', $result['status'], [], 'hu'),
            'cond' => (!empty($result['status']))
        ],
        [
            'th' => "Állapot",
            'td' => "Nem beküldött",
