...
class Module extends \yii\base\Module implements BootstrapInterface
{
    ...
    public function bootstrap($app)
    {
        $app->getUrlManager()->addRules([
            ...
            "PATCH <module:{$this->id}>/<controller:tasks>/update-canvas-task/<id>" => '<module>/<controller>/update-canvas-task',
            ...
            "GET <module:{$this->id}>/<controller:submissions>/<id>/download" => '<module>/<controller>/download',
            "POST <module:{$this->id}>/<controller:submissions>/<id>/start-code-compass" => '<module>/<controller>/start-code-compass',
            "POST <module:{$this->id}>/<controller:submissions>/<id>/stop-code-compass" => '<module>/<controller>/stop-code-compass',
            ...
            "POST <module:{$this->id}>/<controller:submissions>/<id>/jwt" => '<module>/<controller>/jwt-generate',
            "PATCH <module:{$this->id}>/<controller:submissions>/<id>/set-personal-deadline" => '<module>/<controller>/set-personal-deadline',
